...
RSpec.describe TestResultsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested test_result as @test_result" do
      test_result = TestResult.create! valid_attributes
      get :show, params: {id: test_result.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested test_result as @test_result" do
      test_result = TestResult.create! valid_attributes
      get :edit, params: {id: test_result.to_param}, session: valid_session
      expect(assigns(:test_result)).to eq(test_result)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new TestResult" do
        expect {
          post :create, params: {test_result: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved test_result as @test_result" do
        post :create, params: {test_result: invalid_attributes}, session: valid_session
        expect(assigns(:test_result)).to be_a_new(TestResult)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested test_result" do
        test_result = TestResult.create! valid_attributes
        put :update, params: {id: test_result.to_param, test_result: new_attributes}, session: valid_session
        test_result.reload
      ...
      it "assigns the requested test_result as @test_result" do
        test_result = TestResult.create! valid_attributes
        put :update, params: {id: test_result.to_param, test_result: valid_attributes}, session: valid_session
        expect(assigns(:test_result)).to eq(test_result)
      end
    ...
    context "with invalid params" do
      it "assigns the test_result as @test_result" do
        test_result = TestResult.create! valid_attributes
        put :update, params: {id: test_result.to_param, test_result: invalid_attributes}, session: valid_session
        expect(assigns(:test_result)).to eq(test_result)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested test_result" do
      test_result = TestResult.create! valid_attributes
      expect {
        delete :destroy, params: {id: test_result.to_param}, session: valid_session
      }.to change(TestResult, :count).by(-1)
    end
